...
const items = [
  ...
  },
  {
    ...
    liveUrl: "https://tanmay-patel.netlify.app/",
    isLive: true,
  ...
  },
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/Tanmay1407/webRTC-video-calling-app/main/WebRTC_Framework_Flow.png",
    tech: ["WebRTC", "Socket.io", "Express", "React", "Node.js", "TailwindCSS"],
  },
   {
    title: "Recigle - AI Recipe Finder",
    desc: "An innovative Android app that helps you discover delicious recipes based on the ingredients you have at home. Uses ML to suggest personalized recipes and provides step-by-step cooking instructions.",
    url: "https://github.com/Tanmay1407/Recigle",
...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="relative min-h-screen overflow-hidden py-24 flex items-center justify-center"
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        />
        <AccentBlob
          className="absolute -top-40 right-[-8rem]"
          size="h-[32rem] w-[32rem]"
          colors={["#f472b6", "#fbbf24", "#8b5cf6"]}
          opacity={0.13}
          delay={0.3}
          duration={2.3}
          floatDistance={80}
        ...
        />
        <AccentBlob
          className="absolute bottom-[-8rem] left-1/3 -translate-x-1/2"
        ...
        />
        <AccentBlob
          className="absolute bottom-[-4rem] right-1/4"
...
>
  <div className="relative aspect-[16/9] overflow-hidden">
    ...
    <div className="absolute left-2 top-2 flex items-center gap-2">
      <span className="rounded-full border border-white/10 bg-white/10 px-2 py-0.5 text-xs text-white/80 backdrop-blur">
        #{i + 1}
      </span>
      {p.isLive && (
        <span className="flex items-center gap-1.5 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-2 py-0.5 text-xs text-emerald-300 backdrop-blur">
