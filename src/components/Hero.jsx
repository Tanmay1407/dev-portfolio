          ...
          <div className="w-full md:w-[60%] flex flex-col items-start text-left justify-center space-y-6 overflow-hidden">
            ...
            <div className="flex flex-wrap justify-start gap-3">
              <a href="#projects" className="btn ring-1 ring-white/10">
                ...
                <a href="https://drive.google.com/file/d/17rdGlZI6XvxZgMSA8w0YbDb8h7BGQEN-/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn bg-gradient-to-r from-fuchsia-500 to-cyan-500 text-slate-900 shadow-lg shadow-fuchsia-500/10 hover:brightness-110">
